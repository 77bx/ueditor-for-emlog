...
function addattach_img(fileurl,imgsrc,aid,width,height,alt){
	if (UE.getEditor('content').queryCommandState("source")== true){
		...
		UE.getEditor('content').execCommand("insertHtml",'<a target=\"_blank\" href=\"'+fileurl+'\" id=\"ematt:'+aid+'\"><img src=\"'+imgsrc+'\" title="点击查看原图" alt=\"'+alt+'\" border=\"0\" width="'+width+'" height="'+height+'"/></a>');
	}
}
