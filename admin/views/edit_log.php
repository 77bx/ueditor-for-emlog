...
<div>
<script id="content" name="content" type="text/plain"><?php echo htmlspecialchars_decode($content);?></script><div class="clear"></div>
</div>
...
<div id="advset">
<div>文章摘要：</div>
<div>		  <script id="excerpt" name="excerpt" type="text/plain"><?php echo htmlspecialchars_decode($excerpt);?></script>
		  <div class="clear"></div>
</div>
